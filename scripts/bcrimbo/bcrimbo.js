...
function main() {
  ...
  skillbookTable += "\n  <tr>\n    <th></th>\n    <th>Display</th>\n    <th>Display (used)</th>\n    <th>Have (used)</th>\n  </tr>", skillBooks.forEach(function(x) {
    var used = $item(_templateObject63 || (_templateObject63 = _taggedTemplateLiteral(["", " (used)"])), x.name);
  ...
  equipmentTable += "<tr>\n  <th></th>\n  <th>Display</th>\n  <th>Personal</th>\n  <th>Sicko</th>\n  <th>Slot</th>\n  <th>Single Equip</th>\n  </tr>", equippable.forEach(function(x) {
    ...
    switch ((0, import_kolmafia2.toSlot)(x)) {
      case $slot(_templateObject64 || (_templateObject64 = _taggedTemplateLiteral(["hat"]))):
      case $slot(_templateObject65 || (_templateObject65 = _taggedTemplateLiteral(["off-hand"]))):
      case $slot(_templateObject66 || (_templateObject66 = _taggedTemplateLiteral(["pants"]))):
        sickoAmount = 2;
        break;
      case $slot(_templateObject67 || (_templateObject67 = _taggedTemplateLiteral(["weapon"]))):
